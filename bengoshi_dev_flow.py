...
# 弁護士bot_テスト用：EAAHZBLbwxSdQBAGPjgg3IdGTl76jRSZAfHjjjhuq1B3vTHsfczRwMnHoZBEZADRa7Ui4fYNuVMO5aZCza4K582yQwo0gmV8sojNplVW0PGokf06QavX56sqpfC2PemspkASAo8sTPZC85vt12UpQvg0HxExAmffeKf27cvKGfrTwZDZD
        ...
        "greeting": [
            {
                ...
                "text": "初めまして！😄\n"
                        "離婚お悩み相談室の福郎だよ！\n"
                        "ぼくが出す選択肢から選ぶだけでお悩みを具体化して、\n"
                        "さらにあまり知られていない豆知識もおしえてあげるよ！👍\n"
                        "\n"
                        "一人で悩まず、まずはぼくと話してみない？🤔"
            }
        ]
